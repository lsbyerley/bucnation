    ...
    <svg aria-hidden='true' {...props}>
      <defs>
        ...
        <linearGradient id={`${id}-gradient`}>
          ...
          <stop offset='50%' stopColor='#041E42' />
  ...
  return (
    <section {...props}>
      <h2 className='flex items-center font-mono text-sm font-medium leading-7 text-slate-900'>
        <TinyWaveFormIcon
          colors={['fill-yellow-400', 'fill-blue-900']}
      ...
      >
        Each highlight video is uploaded to{' '}
        <a
        ...
        . A new type of decentralized storage where assets live forever on the
        blockchain.
      </p>
      {!isExpanded && (
        <button
    ...
    <>
      <header className='bg-slate-50 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120'>
        ...
        <div className='relative z-10 px-4 pt-10 pb-4 mx-auto sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12'>
          <Link
            href='/'
            className='relative block w-48 p-10 mx-auto overflow-hidden rounded-lg shadow-xl bg-slate-200 shadow-slate-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl'
            aria-label='Homepage'
          >
            <Image
              className='w-full'
          ...
          {/*<section className='mt-10 lg:mt-12'>
            ...
            <ul
              role='list'
              className='flex justify-center gap-10 mt-4 text-base font-medium leading-7 text-slate-700 sm:gap-8 lg:flex-col lg:gap-4'
            >
              {[
                ['Spotify', SpotifyIcon],
      ...
      <footer className='py-10 pb-40 border-t border-slate-200 bg-slate-50 sm:py-16 sm:pb-32 lg:hidden'>
        <div className='px-4 mx-auto sm:px-6 md:max-w-2xl md:px-4'>
          ...
          <h2 className='flex items-center mt-8 font-mono text-sm font-medium leading-7 text-slate-900'>
            ...
            <span className='ml-2.5'>Made by</span>
          </h2>
